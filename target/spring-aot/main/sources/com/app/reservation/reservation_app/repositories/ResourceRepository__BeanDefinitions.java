...
/**
 * Bean definitions for {@link ResourceRepository}.
 */
@Generated
public class ResourceRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'resourceRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getResourceRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'resourceRepository'.
   */
  public static BeanDefinition getResourceRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, ResourceRepository.class, Resource.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.app.reservation.reservation_app.repositories.ResourceRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.ResourceRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.app.reservation.reservation_app.repositories.ResourceRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getResourceRepositoryInstanceSupplier();
