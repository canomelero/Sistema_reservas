...
public class TokenRepository__BeanDefinitions {
  ...
  public static BeanDefinition getTokenRepositoryBeanDefinition() {
    ...
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.app.reservation.reservation_app.repositories.TokenRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.app.reservation.reservation_app.repositories.TokenRepositoryImpl__AotRepository(entityManager, context));
      }
    });
