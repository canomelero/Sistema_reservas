 ...
 */
@Generated
public class ReservationAppApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new ReservationAppApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new ReservationAppApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
  ...
  private void processPropertySources(ConfigurableEnvironment environment,
    ...
    try {
      processor.processPropertySource(new PropertySourceDescriptor("classpath:message.properties"));
  ...
  private void addImportAwareBeanPostProcessors(DefaultListableBeanFactory beanFactory) {
    ...
    mappings.put("org.springframework.security.config.annotation.web.configuration.WebSecurityConfiguration", "com.app.reservation.reservation_app.SecurityConfig");
